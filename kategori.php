...
?>
  ...
  <div id="main_content">
    ...
    <div class="left_content">
      ...
      ?>
        <li class="odd"><a href="?kategori=<?php echo $menu['nm_kategori']; ?>"><?php echo $menu['nm_kategori']; ?></a></li>
        <?php   
              }
              }
    ...
    <div class="center_content">
      ...
      <div class="center_title_bar">Similar products</div>
       <?php $sql = mysqli_query($kon, "SELECT * FROM barang WHERE nm_kategori='$_GET[kategori]'");
